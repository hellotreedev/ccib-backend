...
class ActivityMember extends Model  implements TranslatableContract
{
    ...
    {
        return $this->belongsToMany('App\SectorOfActivity', 'sector_of_activity_activity_member', 'activity_member_id', 'sector_of_activity_id')->orderBy('sector_of_activity_activity_member.ht_pos');
    }
    ...
    {
        return $this->belongsToMany('App\DirectoryList', 'directory_activity_member', 'activity_member_id', 'directory_list_id')->orderBy('directory_activity_member.ht_pos');
    }

    public function members_option()
    {
        return $this->belongsTo('App\MembersOption');
    }

    public function socials()
    {
        return $this->hasMany('App\MemberSocialMedia', 'activity_members_id')->orderBy('ht_pos');
    }
}
