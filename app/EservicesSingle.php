...
class EservicesSingle extends Model  implements TranslatableContract
{
    ...
    public $translatedAttributes = ["title","subtitle","section1_title","section1_excerpt","section1_btn","section2_content","section3_title","section4_content","section5_content","download_btn", "pdf", "pdf_label"];
